using FunctionalSQL.Strategy.MapFilterReduce.Strategies.Basic;
using FunctionalSQL.Strategy.MapFilterReduce.Strategies.Lazy;
using FunctionalSQL.Strategy.MapFilterReduce.Strategies.Memoization;
using FunctionalSQL.Strategy.MapFilterReduce.Strategies.Batch;
using FunctionalSQL.Strategy.MapFilterReduce.Strategies.Composite;
using FunctionalSQL.Strategy.MapFilterReduce.Infrastructure.Sorting;

namespace FunctionalSQL.Strategy.MapFilterReduce;
